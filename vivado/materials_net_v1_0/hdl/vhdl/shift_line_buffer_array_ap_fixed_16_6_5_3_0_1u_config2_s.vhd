...
architecture behav of shift_line_buffer_array_ap_fixed_16_6_5_3_0_1u_config2_s is 
    ...
    signal line_buffer_Array_V_1404_0_ce0 : STD_LOGIC;
    signal line_buffer_Array_V_1404_0_we0 : STD_LOGIC;
    signal line_buffer_Array_V_1404_0_q0 : STD_LOGIC_VECTOR (15 downto 0);
...
begin
    ...
    line_buffer_Array_V_1404_0_U : component shift_line_buffer_array_ap_fixed_16_6_5_3_0_1u_config2_s_line_buffer_Array_V_bkb
    generic map (
        DataWidth => 16,
        AddressRange => 160,
        AddressWidth => 8)
    port map (
        ...
        reset => ap_rst,
        address0 => ap_const_lv8_9F,
        ce0 => line_buffer_Array_V_1404_0_ce0,
        we0 => line_buffer_Array_V_1404_0_we0,
        d0 => line_buffer_Array_V_0_0_q0,
        q0 => line_buffer_Array_V_1404_0_q0);
    ...
    ap_return_4 <= line_buffer_Array_V_1404_0_q0;
    ...
    line_buffer_Array_V_1404_0_ce0_assign_proc : process(ap_start, ap_CS_fsm_state1, ap_ce)
    begin
        if (((ap_start = ap_const_logic_1) and (ap_const_logic_1 = ap_ce) and (ap_const_logic_1 = ap_CS_fsm_state1))) then 
            line_buffer_Array_V_1404_0_ce0 <= ap_const_logic_1;
        else 
            line_buffer_Array_V_1404_0_ce0 <= ap_const_logic_0;
        end if; 
    end process;


    line_buffer_Array_V_1404_0_we0_assign_proc : process(ap_start, ap_CS_fsm_state1, ap_ce)
    begin
        if (((ap_start = ap_const_logic_1) and (ap_const_logic_1 = ap_ce) and (ap_const_logic_1 = ap_CS_fsm_state1))) then 
            line_buffer_Array_V_1404_0_we0 <= ap_const_logic_1;
        else 
            line_buffer_Array_V_1404_0_we0 <= ap_const_logic_0;
        end if; 
    end process;
